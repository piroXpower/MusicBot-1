...
def cb_admin_check(func: Callable) -> Callable:
    async def decorator(client, cb):
        ...
        if cb.from_user.id in admemes:
            ...
            await cb.answer("For This You Need Administration Power !", show_alert=True)
            return
...
async def generate_cover(title, thumbnail, ctitle):
    ...
    font = ImageFont.truetype("Image/regular.ttf", 52)
    font2 = ImageFont.truetype("Image/medium.ttf", 76)
